...
(cdr car)
; expect Error: argument 0 of car has wrong type (object)

(cdr 65)
; expect Error: argument 0 of cdr has wrong type (int)

(cdr (11))
; expect Error: cannot call: 11

(cdr (list 3 4 5 6 7 8 9))
; expect (4 5 6 7 8 9)

(even? 1 2 3 4 5 6 7 8)
; expect Error: Expect 1 arguments, got 8
...
(define (plus-ten s) (+ five 10))
; expect plus-ten

(plus-ten 5)
; expect 15

(define almost-done-with-project '(d.(o.(n.(e)))))
; expect almost-done-with-project

almost-done-with-project
; expect (d. (o. (n. (e))))

(car almost-done-with-project)
; expect d.

(cdr almost-done-with-project)
; expect ((o. (n. (e))))

(define (x h a u) (+ (* h a u) (+ h a u) (- h a u)))
; expect x

(define (y h a u) (* h h h))
; expect y

(x (y 1 2 3) (y 2 3 4) (y 3 4 5))
; expect 218
...
; expect (car (quote (quote (1 2 3))))

'(1 . (2 '(3 '(4 . 5))))
; expect (1 2 (quote (3 (quote (4 . 5)))))

(begin (print 5) (+ 2 3))
; expect 5 ; 5

(begin (print 3) '(* 4 4) '(+ 3 4))
; expect 3 ; (+ 3 4)

(begin (define x 5) (define y (+ x 10)) x)
; expect 5

(begin (define (g o s h) (+ g o) (- s h)) g)
; expect (lambda (o s h) (+ g o) (- s h))

(lambda (x y z))
; expect Error: too few operands in form

(lambda (hotdamn) (+ hotdam 50) (fifty))
; expect (lambda (hotdamn) (+ hotdam 50) (fifty))

(lambda (hotdamn hotdamn not going to work) (+ hotdamn 0))
; expect Error:
...
(if False false (quote 12))
; expect 12

(and True 1 False 2)
; expect False

(and 3 5 True True (1 2 3) (+ 5 3))
...
(cond #f 1 2)
; expect Error: badly formed expression: False
...
(let ((dude (lambda (x) (* x 50)))
      (x 2)
      (where 'where)
      (is 'is)
      (my 'my)
      (chicken (list 'a 'p 'e)))
      (list dude where is my chicken))
; expect ((lambda (x) (* x 50)) where is my (a p e))
